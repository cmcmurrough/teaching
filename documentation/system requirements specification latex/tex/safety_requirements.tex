...
\subsection{All laboratory equipment usage shall comply with OSHA lockout/tagout (LOTO) procedures}
\subsubsection{Description}
Any fabrication equipment provided used in the development of the project shall be used in accordance with LOTO procedures. Locks and tags are installed on all equipment items that present use hazards, and ONLY the course instructor or designated teaching assistants may remove a lock. All locks will be immediately replaced once the equipment is no longer in use.
...
\subsection{All system wiring shall conform to National Electric Code (NEC)}
\subsubsection{Description}
...
\subsection{All robotic systems shall comply with RIA safety standards}
\subsubsection{Description}
